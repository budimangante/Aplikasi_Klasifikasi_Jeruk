...
class Model:
    ...
    def predict_from_image(self, image_file):
        ...
        # Confidence untuk kelas terprediksi
        confidence = float(predictions[0][predicted_class_index])

        # Membuat dictionary untuk semua probabilitas
        all_probabilities = {}
        for i, class_name in enumerate(class_names):
            all_probabilities[class_name] = float(predictions[0][i] * 100)  # Konversi ke persentase
